...
Note for users: If you are using this guide, it is either because:
...
1. **top_x_species_presence**: Whether the species is present, with respect to its known activity.
2. **top_x_species_within_date**: Whether the species is active at the given date, with respect to its known phenology.
